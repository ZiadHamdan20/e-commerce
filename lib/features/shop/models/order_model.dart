...
class OrderModel {
  ...
  String get formattedOrderDate => CustomHelpers.getFormattedDate(orderDate);

  String get formattedDeliveryDate => deliveryDate != null ? CustomHelpers.getFormattedDate(deliveryDate!) : '';
