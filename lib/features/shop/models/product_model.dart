...
import 'package:ecommerce_app/features/shop/models/product_attributes_model.dart';
...
class ProductModel {
  ...
  /// Returns empty form of given model
...
/// Map Json oriented document snapshot from Firebase to Model
  factory ProductModel.fromSnapshot(DocumentSnapshot<Map<String, dynamic>> document) {
    ...
    return ProductModel(
      ...
      sku: data['SKU'],
      title: data['Title'],
      stock: (data['Stock'] is int) ? data['Stock'] : int.tryParse(data['Stock'].toString()) ?? 0,

     // stock: data['Stock'] ?? 0,
      isFeatured: data['IsFeatured'] ?? false,
      price: (data['Price'] is double) ? data['Price'] : double.tryParse(data['Price'].toString()) ?? 0.0,
      salePrice: (data['SalePrice'] is double) ? data['SalePrice'] : double.tryParse(data['SalePrice'].toString()) ?? 0.0,
