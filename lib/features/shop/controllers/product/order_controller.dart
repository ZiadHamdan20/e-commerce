  ...
  void processOrder(double totalAmount) async {
    try {
      ...
      CustomFullScreenLoader.openLoadingDialog(
          'Processing your order', CustomImageStrings.pencilAnimation);
      ...
      Get.off(() =>
          SuccessScreen(
            image: CustomImageStrings.orderCompletedAnimation,
            title: 'Payment Success!',
            subTitle: 'Your item will be shipped soon!',
            onPressed: () => Get.offAllNamed(PagesNames.navigationMenu),
          )); // SuccessScreen
    } catch (e) {
