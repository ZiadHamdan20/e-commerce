...
screenRedirect()async{
    ...
    if (user !=null) {
      if (user.emailVerified) {
        ...
        Get.offAllNamed(PagesNames.verifyEmailScreen,arguments:[_auth.currentUser?.email] );
      }
      ...
      Get.offAllNamed(PagesNames.logInScreen)//Redirect to login screen if not the first time
          :Get.offAllNamed(PagesNames.onBoardingScreen); //Redirect to OnBoarding screen if its the first time
